...
library. Donations support continuous improvement and maintenance. The aim is a reliable,
...
Greatly appreciated.}
  spec.homepage              =
      'https://docs.diligentsoftware.org/datastructureerror-1'
  spec.license               = "MIT"
  ...
  spec.metadata["changelog_uri"]   = "https://docs.diligentsoftware" +
      ".org/datastructureerror-1#changelog"
  ...
  spec.add_runtime_dependency 'data_structure_error_impl', '~> 1.5.0'
